...
for len in {3.4,3.6,3.8,4.0}; do \
        mpirun -np 25 ./main.py CNT --stage1 --stage2 --single_stage --MAXITER_stage_1 50 --MAXITER_stage_2 1500 --MAXITER_single_stage 500 --max_modes 3 --lengthbound $len > outputs/CNT_length${len}_circular.txt &
done
wait
