...
MAXITER_stage_1 = 80 # Number of iterations to perform in the stage 1 optimization
...
MAXITER_single_stage = 2500 # Number of iterations to perform in the main optimization loop
# Flags
...
LENGTH_WEIGHT = 5e-07 # Weight on the curve lengths in the objective function
