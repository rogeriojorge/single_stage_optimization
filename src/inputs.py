...
LENGTHBOUND_CNT = 3.6 # Threshold for the length of each coil
CC_THRESHOLD_CNT = 0.15 # Threshold for the coil-to-coil distance penalty in the objective function
CURVATURE_THRESHOLD_CNT = 10.0 # Threshold for the curvature penalty in the objective function
MSC_THRESHOLD_CNT = 10.0 # Threshold for the mean squared curvature penalty in the objective function
include_iota_target_CNT = True # Specify if iota should be added to the objective function
iota_target_CNT = -0.27 # Target rotational transform iota
