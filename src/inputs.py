...
CURVATURE_THRESHOLD_QI = 12 # Threshold for the curvature penalty in the objective function
MSC_THRESHOLD_QI = 12 # Threshold for the mean squared curvature penalty in the objective function
...
nphi_QI=151 # Number of points along measured along each well
nalpha_QI=31 # Number of wells measured
nBj_QI=61 # Number of bounce points measured
